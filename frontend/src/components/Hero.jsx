        ...
        <div className="flex justify-center items-center text-white">
            <div className="max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center p-10">
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div>
                    <Link to={"/stream"}><button type="button" class="text-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 my-2">Get Started</button>
                    </Link>
                    </div>
                </div>
            </div>
